...
operator fun Z3Expr.minus(other: Long): Z3Expr =
    Z3ArithExpr(ctx, ctx.mkSub(expr, ctx.mkInt(other)))

operator fun Long.minus(other: Z3Expr): Z3Expr =
    Z3ArithExpr(other.ctx, other.ctx.mkSub(other.ctx.mkInt(this), other.expr))

operator fun Z3Expr.minus(other: Z3Expr): Z3Expr =
    Z3ArithExpr(other.ctx, other.ctx.mkSub(expr, other.expr))

operator fun Z3Expr.plus(other: Long): Z3Expr =
    Z3ArithExpr(ctx, ctx.mkAdd(expr, ctx.mkInt(other)))

operator fun Long.plus(other: Z3Expr): Z3Expr =
    Z3ArithExpr(other.ctx, other.ctx.mkAdd(other.ctx.mkInt(this), other.expr))

operator fun Z3Expr.plus(other: Z3Expr): Z3Expr =
    Z3ArithExpr(ctx, ctx.mkAdd(expr, other.expr))

operator fun Z3Expr.times(other: Long): Z3Expr =
    Z3ArithExpr(ctx, ctx.mkMul(expr, ctx.mkInt(other)))

operator fun Long.times(other: Z3Expr): Z3Expr =
    Z3ArithExpr(other.ctx, other.ctx.mkMul(other.ctx.mkInt(this), other.expr))

operator fun Z3Expr.times(other: Z3Expr): Z3Expr =
    Z3ArithExpr(ctx, ctx.mkMul(expr, other.expr))

operator fun Z3Expr.div(other: Long): Z3Expr =
    Z3ArithExpr(ctx, ctx.mkDiv(expr, ctx.mkInt(other)))

operator fun Long.div(other: Z3Expr): Z3Expr =
    Z3ArithExpr(other.ctx, other.ctx.mkDiv(other.ctx.mkInt(this), other.expr))

operator fun Z3Expr.div(other: Z3Expr): Z3Expr =
    Z3ArithExpr(other.ctx, other.ctx.mkDiv(expr, other.expr))

infix fun Z3Expr.eq(other: Z3Expr): Z3BoolExpr =
    Z3BoolExpr(ctx, ctx.mkEq(this.expr, other.expr))
...
class Z3Context(private val ctx: Context) {
    ...
    fun mkOptimize(): Optimize = ctx.mkOptimize()
    ...
    fun eval(expr: Z3Expr): String =
        model.eval(expr.expr, true).toString()
}
